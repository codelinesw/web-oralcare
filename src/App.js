...
import Antisarro from './screens/Multibeneficios/Antisarro';
...
import CuidadoFamiliarTripleAccion360 from './screens/CuidadoFamiliar/CuidadoFamiliarTripleAccion360';
...
import CuidadoDeLosMasPequesMyFirst from './screens/CuidadoDeLosMasPeques/CuidadoDeLosMasPequesMyFirst';
import CuidadoDeLosMasPequesKids from './screens/CuidadoDeLosMasPeques/CuidadoDeLosMasPequesKids';
    ...
    return (
       ...
       <Router>
        <Switch>
          ...
          />                   
          <Route
            path="/cuidadofamiliartripleaccion360"
            component={CuidadoFamiliarTripleAccion360}
          />                   
          <Route
          ...
          />
          <Route
            path='/cuidadodelosmaspequesmyfirst'
            component={CuidadoDeLosMasPequesMyFirst}
          />
          <Route
            path='/cuidadodelosmaspequesmykids'
            component={CuidadoDeLosMasPequesKids}
          />
          <Route
