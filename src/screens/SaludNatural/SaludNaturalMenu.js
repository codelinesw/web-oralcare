      ...
      <div className="container-fluid">
        ...
        <div className="row m-auto d-block" style={{ position: 'relative', top: '0px', width: '90%' }}>
          <div className="row w-100 m-auto mb-0 container-box" style={{ position: 'relative', top: '20px' }}>
            ...
            <div className="w-50 d-flex justify-content-between m-auto" style={{position:'relative',left:'350px'}}>
              <div className="column col-sm-7 mr-5 boxBottomTwo" style={{ position: 'relative',right:'20px' }}>
                <Link to="/saludnaturalpurificante/"><img src={imgThree} className="boxImage" style={{ position: 'relative', top: '70px' }} /></Link>
              </div>
              <div className="column col-sm-12 ml-5 boxBottomThree" style={{ position: 'relative',left:'-25px' }}>
                <Link to="/saludnaturalbamboo/"><img src={imgFour} className="boxImage" style={{ position: 'relative', top: '-190px' }} /></Link>
              </div>
            </div>
          </div>
          <Footer screenNext="saludnaturaldefensareforzada" screenPrev="imagecarousel" history={this.props.history} top="95px" />
        </div>
      </div>
    );
  }
