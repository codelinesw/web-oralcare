    ...
    return (
      <div className="container-fluid">
        ...
        <div className="card-header bg-transparent border-0 d-flex justify-content-center">
          <img src={titulo} alt="Segmentos" style={{ position: 'relative', width: '600px', left: '0px', top: '180px' }} />
        </div>
              ...
              <div className="_item_ w-100 d-flex justify-content-center">
                <div className="w-100 d-flex justify-content-center content-carousel">
                  <li style={{ listStyle: 'none', marginRight: '40px', marginTop: '25px' }}>
                    <Link to="/multibeneficiosmenu/"><img src={imgOne} className="image-carousel" style={{ transform: 'scale(1.2)' }} /></Link>
                  </li>
                  <li style={{ listStyle: 'none', marginRight: '40px', marginTop: '25px' }}>
                    <Link to="/blanqueamientomenu/"><img src={imgTwo} className="image-carousel" style={{ transform: 'scale(1.2)' }} /></Link>
                  </li>
                  <li style={{ listStyle: 'none', marginRight: '40px', marginTop: '25px' }}>
                    <Link to="/saludnaturalmenu/"><img src={imgThree} className="image-carousel" style={{ transform: 'scale(1.2)' }} /></Link>
                  </li>
                  <li style={{ listStyle: 'none', marginRight: '40px', marginTop: '30px' }}>
                    <Link to="/cuidadofamiliarmenu/"><img src={imgFour} className="image-carousel" style={{ transform: 'scale(1.2)' }} /></Link>
                  </li>
                  <li style={{ listStyle: 'none', marginRight: '40px', marginTop: '25px' }}>
                    <Link to="/sensibilidadmenu/"><img src={imgFive} className="image-carousel" style={{ transform: 'scale(1.1)' }} /></Link>
                  </li>
                  <li style={{ listStyle: 'none', marginRight: '0px', marginTop: '25px' }}>
                    <Link to="/cuidadodelosmaspequesmenu/"><img src={imgSix} className="image-carousel" style={{ transform: 'scale(1.2)' }} /></Link>
                  </li>
                </div>
              </div>
            </div>
