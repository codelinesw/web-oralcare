        ...
        <div className="row m-auto d-block" style={{ position: 'relative', top: '0px', width: '90%' }}>
          <div className="card m-auto bg-transparent border-0 ">
            ...
            <div className="card-body d-flex justify-content-center w-100" style={{ marginTop: '90px' }}>
              <div className="column pr-4" style={{ position: 'relative', right: '135px' }}>
                <div style={{ display: 'column' }}>
                  <p className="small text-muted text-normal " style={{ position: 'relative', right: '-25px', fontSize: '25px', marginTop: '150px' }}>Cambia tu cepillo cuando sus</p>
          ...
          <Footer screenNext="consejosparaunabocasana" screenPrev="mejoratusonrisa" currentScreen="Blanqueamiento" history={this.props.history} top="456px" />
        </div>
      </div>
    );
  }
