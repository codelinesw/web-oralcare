    ...
    return (
      <div className="container-fluid">
        ...
        <div className="row m-auto d-block" style={{ position: 'relative', top: '0px', width: '90%' }}>
            ...
            <div className="card-body d-flex justify-content-center w-100" style={{ marginTop: '90px' }}>
              <div className="column pr-4" style={{ position: 'relative', right: '130px' }}>
                <div style={{ display: 'column' }}>
                  <img src={numerosuno} style={{ position: 'absolute', width: '45px', height: '170px', left: '-45px', marginTop: '0px' }} />
                  <p className="small text-muted text-normal " style={{ position: 'relative', right: '-25px', fontSize: '25px', marginTop: '85px' }}>Usar el cepillo dental adecuado para la necesidad de tu boca.</p>
                  <p className="small text-muted text-normal " style={{ position: 'relative', right: '-25px', fontSize: '25px' }}>Cepíllate 3 veces al día por al menos 2 minutos, especialmente</p>
                  <p className="small text-muted text-normal " style={{ position: 'relative', right: '-25px', fontSize: '25px' }}>al levantarse por la mañana y antes de acostarse.</p>
              ...
              <div className="column pl-5 pt-4">
                <img src={numerosdos} style={{ position: 'absolute', width: '40px', height: '150px', right: '605px', marginTop: '50px' }} />
                <p className="small text-muted text-normal " style={{ position: 'relative', left: '140px', fontSize: '25px', marginTop: '60px' }}>Finaliza tu higiene bucal con un enjuague</p>
                <p className="small text-muted text-normal " style={{ position: 'relative', left: '140px', fontSize: '25px' }}>bucal que potencie la acción de tu crema</p>
                <p className="small text-muted text-normal " style={{ position: 'relative', left: '140px', fontSize: '25px' }}>dental.</p>
                <p className="small text-muted text-normal " style={{ position: 'relative', left: '140px', fontSize: '25px', marginTop: '45px' }}>Usa hilo dental una vez al día.</p>
              </div>
            </div>
            <div className="row d-flex justify-content-center">
              <div className="column ml-5">
                <div className="d-flex" style={{ position: 'relative', left: '0px' }}>
                  <img src={imagenuno} style={{ position: 'relative', width: '200px', marginTop: '137px' }} />
              ...
              <div className="column mr-5 ml-5">
                <div className="d-flex" style={{ position: 'relative', left: '0px' }}>
                  <img src={imagendos} style={{ position: 'relative', width: '200px', marginTop: '137px' }} />
                  <div className="column">
              ...
              <div className="column ml-5">
                <div className="d-flex" style={{ position: 'relative', left: '-50px' }}>
                  <img src={imagentres} style={{ position: 'relative', width: '200px', marginTop: '137px' }} />
                  <div className="column">
                    <p className="small text-muted text-normal " style={{ fontSize: '25px', marginTop: '150px', marginLeft: '15px' }}>Sujete el hilo con firmeza alrededor</p>
          ...
          <Footer screenNext="mejoratusonrisa" screenPrev="mejoratusonrisa" currentScreen="Blanqueamiento" history={this.props.history} top="176px" />
        </div>
      </div>
    );
  }
