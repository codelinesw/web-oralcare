      ...
      <div className="container-fluid">
        ...
        <div className="row m-auto d-block" style={{ position: 'relative', top: '0px', width: '90%' }}>
          <div className="card m-auto bg-transparent border-0 ">
            ...
            <div className="card-body d-flex justify-content-center align-items-center w-100" style={{ position: 'relative'}}>
              <p className="small text-muted text-normal top-30" style={{ position: 'relative', fontSize:'50px', fontWeight:'bold'}}>PRESIONA CADA TIP PARA CONOCER MÁS</p>
            </div>
          </div>
