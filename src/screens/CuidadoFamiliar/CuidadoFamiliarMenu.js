...
import imgSeven from '../../images/Productos/CuidadoFamiliar/Menu/07.png';
        ...
        <div className="row m-auto d-block" style={{ position: 'relative', top: '0px', width: '90%' }}>
          <div className="row w-100 m-auto mb-0 container-box" style={{ position: 'relative', top: '20px' }}>
            <div className="w-75 d-flex justify-content-between m-auto">
              ...
              <div className="column">
                <Link to="/cuidadofamiliarsoftmint/"><img src={imgSeven} className="boxImage boxTopTwo" style={{ position: 'relative', top: '70px' }} /></Link>
              </div>
            </div>
            ...
            <div className="w-50 d-flex justify-content-between m-auto">
              <div className="column col-sm-7 mr-5 boxBottomTwo" style={{ position: 'relative' }}>
                <Link to="/cuidadofamiliarxtrablancura/"><img src={imgThree} className="boxImage" style={{ position: 'relative', top: '-100px', right:'180px' }} /></Link>
              </div>
              <div className="column col-sm-12 ml-5 boxBottomThree">
                <Link to="/cuidadofamiliarxtrafrescura/"><img src={imgFour} className="boxImage" style={{ position: 'relative', top:'70px', right:'270px' }} /></Link>
              </div>
              <div className="column col-sm-12 ml-5 boxBottomFour">
                <Link to="/cuidadofamiliartripleaccion/"><img src={imgFive} className="boxImage" style={{ position: 'relative', top:'70px',right:'250px'}} /></Link>
              </div>
              <div className="column col-sm-12 ml-5 boxBottomFour">
                <Link to="/cuidadofamiliartripleaccion360/"><img src={imgSix} className="boxImage" style={{ position: 'relative', top:'-100px',right:'750px'}} /></Link>
              </div>
            </div>
          </div>
          <Footer screenNext="cuidadofamiliarmaximaproteccion" screenPrev="imagecarousel" history={this.props.history} top="147px" />
        </div>
      </div>
    );
  }
