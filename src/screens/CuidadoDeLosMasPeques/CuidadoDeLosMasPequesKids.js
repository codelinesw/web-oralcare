        ...
        <div className="row m-auto d-block container-items" style={{ position: 'relative', top: '0px', width: '90%' }}>
          <div className="card m-auto bg-transparent border-0 container-box">
            ...
            <div className="card-body d-flex justify-content-center w-100" style={{position:'relative', top:'150px'}}>
              ...
              <div className="column" style={{position:"relative",top:'0px',left:'0px'}}>
          ...
          <Footer screenNext="cuidadodelosmaspequescepillos" screenPrev="cuidadodelosmaspequesmenu" currentScreen="Cuidadochicos" showsubmenu={true} history={this.props.history} top="105px" />
        </div>
      </div>
    );
  }
