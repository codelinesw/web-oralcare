    ...
    return (
      <div className="container-fluid">
        ...
        <div className="row m-auto d-block" style={{ position: 'relative', top: '0px', width: '90%' }}>
          <div className="card m-auto bg-transparent border-0 ">
            ...
            <div className="card-body d-flex justify-content-center w-100">
              ...
              <div className="column pl-5 pt-4">
                <p className="small text-muted text-normal textmove" style={{ position: 'relative', right: '60px', marginTop: '70px' }}>Ayuda a mantener el blanco natural de</p>
          ...
          <Footer screenNext="blanqueamientomenu" screenPrev="blanqueamientomenu" currentScreen="Blanqueamiento" top="72px" showsubmenu={true} history={this.props.history} />
        </div>
      </div>
    );
  }
