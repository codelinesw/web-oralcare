    ...
    return (
      <div className="container-fluid">
        ...
        <div className="row m-auto d-block" style={{ position: 'relative', top: '0px', width: '90%' }}>
          <div className="card m-auto bg-transparent border-0 ">
            ...
            <div className="card-body d-flex justify-content-center w-100">
              <div className="column pr-4">
                <img src={img} alt="Carbón Activado" style={{ position: 'relative', top: '130px', left:'-50px' }} />
              </div>
              <div className="column pl-5 pt-4" style={{ position: 'relative', top: '70px', right:'-200px' }} >
          ...
          <Footer screenNext="maxwhite" screenPrev="blanqueamientomenu" currentScreen="Blanqueamiento" showsubmenu={true} history={this.props.history} top="236px" />
        </div>
      </div>
    );
  }
